...
def execute_processing():
    ...
    if GR == 'Y':
        ...
        clean_rename_move_file("exports/goodreads_exports", "/Users/valen/Downloads", "goodreads_library_export.csv", "gr_export.csv")
        process_gr_export()
    ...
    if LFM == 'Y':
        ...
        clean_rename_move_file("exports/lfm_exports", "/Users/valen/Downloads", "entinval.csv", "lfm_export.csv")
        process_lfm_export()
    ...
    if PCC == 'Y':
        ...
        clean_rename_move_file("exports/pocket_casts_exports", "/Users/valen/Downloads", "data.txt", "data.txt")
        process_pocket_casts_export()
        file_names.append('processed_files/pocket_casts_processed.csv')
    ...
    if GAR == 'Y':
        ...
        clean_rename_move_folder("exports", "/Users/valen/Downloads", "garmin_export_unzipped", "garmin_exports")
        process_garmin_export()
        file_names.append('processed_files/garmin_activities_list_processed.csv')
        file_names.append('processed_files/garmin_activities_splits_processed.csv')
        file_names.append('processed_files/garmin_sleep_processed.csv')
        file_names.append('processed_files/garmin_training_history_processed.csv')
    ...
    if KIN == 'Y':
        ...
        clean_rename_move_folder("exports", "/Users/valen/Downloads", "kindle_export_unzipped", "kindle_exports")
    ...
    if (KIN == "Y") | (GR == 'Y'):
        ...
        merge_gr_kindle()
        file_names.append('processed_files/kindle_gr_processed.csv')
        print('kindle_gr_processed.csv was created\n')
        print('----------------------------------------------')
    if MM == 'Y':
        print('----------------------------------------------')
        print('Starting the processing of the Money Mgr export \n')
        clean_rename_move_file("exports/moneymgr_exports", "/Users/valen/Downloads", f"{date.today().strftime('%Y-%m-%d')}.xlsx", "moneymgr_export.xlsx")
        process_moneymgr_export()
        file_names.append('processed_files/moneymgr_processed.csv')
        print('moneymgr_processed.csv was created \n')
        print('----------------------------------------------')
    if NUT == 'Y':
        print('----------------------------------------------')
        print('Starting the processing of the Nutrilio export \n')
        clean_rename_move_file("exports/nutrilio_exports", "/Users/valen/Downloads",\
    ...
    if APH == 'Y':
        ...
        clean_rename_move_folder("exports", "/Users/valen/Downloads", "apple_export_unzipped", "apple_exports")
        process_apple_export()
        file_names.append('processed_files/apple_processed.csv')
    ...
    if OFF == 'Y':
        ...
        for f in os.listdir('/Users/valen/Downloads'):
            if re.match(csv_regex, f):
                count_file += 1
                clean_rename_move_file("exports/offscreen_exports", "/Users/valen/Downloads", f, f.split('0-')[1], count_file)
        print("No new offscreen export to process") if count_file == 0 else None
        process_offscreen_export()
        file_names.append('processed_files/offscreen_processed.csv')
    ...
    if LBX == 'Y':
        ...
        clean_rename_move_folder("exports", "/Users/valen/Downloads", "letterboxd_export_unzipped", "letterboxd_exports")
        process_letterboxd_export()
        file_names.append('processed_files/letterboxd_processed.csv')
    ...
    if WEA == 'Y':
        ...
        get_weather_data()
        file_names.append('processed_files/weather_processed.csv')
