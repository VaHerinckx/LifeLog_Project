...
def full_apple_pipeline(auto_full=False, auto_process_only=False):
    ...
    """
    print("\n" + "="*60)
    print("🍎 APPLE HEALTH SOURCE PROCESSOR")
    print("="*60)
    ...
    print("\n" + "="*60)
    if success:
        print("✅ Apple Health source processor completed successfully!")
        # Record successful run with new tracking name
        record_successful_run('source_apple', 'active')
    else:
        print("❌ Apple Health source processor failed")
    print("="*60)
...
if __name__ == "__main__":
    ...
    print("🍎 Apple Health Source Processing Tool")
    print("This tool downloads and processes Apple Health data.")
