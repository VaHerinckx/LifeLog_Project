...
def full_kindle_pipeline(auto_full=False, auto_process_only=False):
    ...
    print("\n" + "="*60)
    if success:
        print("✅ Kindle source processor completed successfully!")
        # Record successful run with new tracking name
        record_successful_run('source_kindle', 'active')
    else:
        print("❌ Kindle source processor failed")
    print("="*60)
...
if __name__ == "__main__":
    ...
    print("📖 Kindle Source Processing Tool")
    print("This tool downloads and processes Kindle reading data.")
