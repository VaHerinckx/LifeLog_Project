...
def create_moneymgr_file():
    ...
    """
    print("⚙️  Processing Money Manager source data...")
    ...
    try:
        ...
        print(f"💾 Saving source processed data to {output_file}...")
...
def full_moneymgr_pipeline(auto_full=False, auto_process_only=False):
    ...
    """
    print("\n" + "="*60)
    print("💰 MONEY MANAGER SOURCE DATA PIPELINE")
    print("="*60)
    ...
    print("\n" + "="*60)
    if success:
        print("✅ Money Manager source pipeline completed successfully!")
        print("ℹ️  Note: To upload to Drive, run the Finance topic pipeline.")
        # Record successful run
        record_successful_run('source_moneymgr', 'active')
    else:
        print("❌ Money Manager source pipeline failed")
    print("="*60)
...
def process_moneymgr_export(upload="Y"):
    ...
    """
    print("⚠️  process_moneymgr_export() is deprecated.")
...
if __name__ == "__main__":
    ...
    print("💰 Money Manager Source Processing Tool")
    print("This tool processes Money Manager exports into source data files.")
    print("For website generation and upload, use the Finance topic coordinator.")
