...
def upload_garmin_results():
    ...
    Returns True if successful, False otherwise.
    """
    print("☁️  Uploading Garmin results to Google Drive...")
    ...
    try:
        ...
        if success:
            print("✅ Garmin results uploaded successfully!")
...
def full_garmin_pipeline(auto_full=False):
    ...
    if choice == "1":
        ...
        print("\n⚙️  Processing existing Garmin file only...")
